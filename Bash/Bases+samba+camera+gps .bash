#!/bin/bash
#On fait en sorte de pouvoir acceder a internet 
export http_proxy=http://172.16.0.1:3128 
export https_proxy=https://172.16.0.1:3128 
cd /home/
echo  "Bon Yes=[y] et Non=[n]"
read reponse
#MAJ et tout le tralala et bonus si bug au cas 
apt-get update && apt-get upgrade 
apt install nano && apt install ssh
apt install ifupdown
apt install ifupdown2

#Installation du proxy 
chromium-browser --proxy-server="172.16.0.1:3128" 
#Installation de Samba
apt-get install samba samba-common-bin
#Placement d'info pour utiliser samba
...
#Donner les droit a tout le monde pour acceder au dossier echange
cd /home
mkdir echange
chmod +777 /home/echange
# Pour la caméra
#Installation de motion pour utiliser la camera
apt-get install motion -y
mkdir /home/pi/captures
chown motion:motion /home/pi/captures
cp /etc/motion/motion.conf /etc/motion/motion.conf.back





echo "# Rename this distribution example file to motion.conf
#
...
############################################################
Enable IPv6 (default: on)
ipv6_enabled 172.16.2.40
...
stream_authentication username:cris:123
...
echo "Pour demarrer le processus de visionage il faut taper 'motion' ainsi apres avoir taper l'ip de la machine ont peut voir la sortie de la caméra"
read -p "okay ? 'y' or 'n' "
#
...
chromium-browser http://$IP/

URL=http://$IP/page?id=utilisateur&mdp=mot-de-passe
firefox $URL


apt install mu-editor
apt-get install gpsprune
cd /home/pi
mkdir gps_experimentation
cd gps_experimentation

chmod +777 /home/pi/gps_experimentation


#Commande pour GPS:
#Vérifier les dernières connexions sur raspberry pi: 
#tail -f /var/log/syslog
#Définir la vitesse du débit
#stty -F /dev/ttyUSB0 4800

#Données de provenance GPS :
#cat /dev/ttyUSB0
